...
try {
    ...
    if ($response -> HighestSeverity != 'FAILURE' && $response -> HighestSeverity != 'ERROR'){  	
        ...
        $amount = '<td>$' . number_format($rateReply->RatedShipmentDetails->ShipmentRateDetail->TotalBaseCharge->Amount+0.35,2,".",",") . '</td>';
        //$amount = '<td>$' . number_format($rateReply->RatedShipmentDetails->ShipmentRateDetail->TotalNetCharge->Amount,2,".",",") . '</td>';
        
        // echo '<pre>';
        // var_dump($rateReply->RatedShipmentDetails->ShipmentRateDetail->TotalNetCharge->Amount);
        // echo '</pre>';
