...
function getProperty($var){
	if($var == 'key') Return 'Z6AVzkmm7MEOacO9'; 
	if($var == 'password') Return 'OlSVHSRthKiQFcVmIuN0qI7jQ'; 
	if($var == 'shipaccount') Return '510087909';
	if($var == 'billaccount') Return '510087909'; 
	if($var == 'dutyaccount') Return '510087909'; 
	if($var == 'freightaccount') Return '510087909';  
	if($var == 'trackaccount') Return '510087909'; 
	if($var == 'dutiesaccount') Return '510087909';
	if($var == 'importeraccount') Return '510087909';
	if($var == 'brokeraccount') Return '510087909';
	if($var == 'distributionaccount') Return '510087909';
