...
<ns1:PostalCode>38017</ns1:PostalCode><ns1:CountryCode>US</ns1:CountryCode></ns1:Address></ns1:Shipper>
...
<ns1:Weight><ns1:Units>LB</ns1:Units><ns1:Value>1</ns1:Value></ns1:Weight>
<ns1:Dimensions>
<ns1:Length>1</ns1:Length>
...
print '<pre>';
print 'FEDEX_GROUND Rate: $';
print (string) $result->SOAPENVBody->RateReply->RateReplyDetails->RatedShipmentDetails[0]->ShipmentRateDetail->TotalBaseCharge->Amount;
print '<hr/>';
print_r($result);
